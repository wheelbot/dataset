...
This script processes all CSV files in data/yaw_circle, applies the complementary
filter to estimate orientation, and updates the q_yrp and dq_yrp fields with
the filter output. The original files are backed up with .backup extension.
"""
...
# Import the Estimator from the filter_complementary module
from filter_complementary import Estimator, run_filter_on_experiment

# Add parent directory to path for wheelbot_dataset import
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..'))

from wheelbot_dataset.usage.dataset import Experiment
