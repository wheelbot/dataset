...
def run_experiment(velocity, roll, pitch, dt, host="192.168.10.102", locallogfile = "log/tmp.csv", video_device=None):
...
def plot_and_run_sequence(velocity, roll, pitch, time, dt, wheelbot_name, surface, video_device, path="excitation_sequences/test"):
    ...
    experiment_failed = run_experiment(velocity, roll, pitch, dt, host, locallogfile=locallogfile, video_device=video_device)
